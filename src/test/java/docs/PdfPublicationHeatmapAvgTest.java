...
public class PdfPublicationHeatmapAvgTest extends BasePublicationTest {
    ...
    public static Collection<Object[]> data() {
		return getAllDocumentsWithStrategy(new DefaultStrategy(new HeatmapResolver(HeatmapResolver.THRESHOLD.AVERAGE)));
    }
