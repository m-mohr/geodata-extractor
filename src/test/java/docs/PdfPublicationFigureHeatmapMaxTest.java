...
public class PdfPublicationFigureHeatmapMaxTest extends BasePublicationTest {
    ...
    public static Collection<Object[]> data() {
		return getAllFiguresWithStrategy(new DefaultStrategy(new HeatmapResolver(HeatmapResolver.THRESHOLD.MAX_SCORE)));
    }
