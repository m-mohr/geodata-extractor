 ...
 * ====================================================================
 *
 * ClavinIndexDirectoryBuilder.java
 *
 *###################################################################*/
 ...
 *
 */
public class ClavinIndexDirectoryBuilder {
    private final static Logger LOG = LoggerFactory.getLogger(ClavinIndexDirectoryBuilder.class);
    ...
    public ClavinIndexDirectoryBuilder(final boolean fullAncestryIn) {
